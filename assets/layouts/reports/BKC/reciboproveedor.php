...
$queryPago = Controller::$connection->query("select * from pago_proveedor as pc
inner join proveedor as c on pc.idProveedor = c.idProveedor
where pc.idpago_proveedor = '$cod'");
...
$idpago_cliente = $dataPago[0]["idpago_proveedor"];
$fecha = $dataPago[0]["fecha"];
$cliente = $dataPago[0]["idProveedor"];
$nombre_cliente = $dataPago[0]["nombre"];
$total_abonado = $dataPago[0]["total_abono"];
$saldoAnterior = $dataPago[0]["saldo"];
