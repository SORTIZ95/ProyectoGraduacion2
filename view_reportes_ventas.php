            ...
            <div id="CLIENTE" class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
                                ...
                                <a data-toggle="collapse" data-target="#CLIENTE-panel">
                                    <strong>RENDIMIENTO POR CATEGORIAS </strong>
                                </a>
                        ...
                        <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="fecha_1c" class="datepicker form-control" placeholder="FECHA" aria-describedby="basic-addon" type="text">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="fecha_2c" class="datepicker form-control" placeholder="FECHA" aria-describedby="basic-addon" type="text">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <button id="print" template="RPTventaCategoria" type="button" class="print btn btn-default btn-md btn-block">
                                        <span class="glyphicon glyphicon-print" aria-hidden="true"></span> Imprimir Reporte
                                    </button>
                                        <br>
                                </div>
